...
pub fn call(arguments: &Value) -> Result<String, String> {
    ...
    let review_report =
        build_review_report(scan_result.summary, &path, base, head, None, &repo_config)
