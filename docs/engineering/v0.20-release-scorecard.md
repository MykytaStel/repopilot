...
- [x] Deterministic outputs across thread counts
  - dedicated determinism test passes with 1, 2, and 4 worker threads
- [ ] Cache invalidation and corruption recovery tested
  - cache tests cover: hit, miss, file changed, file added, file removed,
    corrupted cache file
- [x] Memory result recorded
  - `cargo bench --bench scan_bench` measured a 41,157,112-byte peak memory footprint
