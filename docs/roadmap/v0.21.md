...
v0.21 release candidate metadata is synchronized at `0.21.0`: Cargo and npm
packages, native package pins, the first-party Action, reusable workflow, curated
release notes, and the dated changelog. After the release PR passes the complete
