...
Status: Phase 0 implementation in progress; release closure scope frozen on
2026-09-24. Phases A, C, and D are implemented on `main`; Phase B ships the
dependency, delivery, runtime-configuration, and security/test families; the
independent-evidence part of Phase E moves to 0.24. The remaining pre-tag work
is the [Release Closure Plan](#release-closure-plan) below.
...
Items 1–5 and the RP23-021 fixtures are implemented on
`fix/v023-first-screen-truth` (2026-09-24) and close when it merges.
