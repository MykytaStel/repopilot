...
the first additive review projection is now implemented. A follow-up hardening
slice keeps unsupported delivery coverage, skipped verification state, and
review-SARIF proof parity explicit.
