...
Status: 0.23.0 release prepared on 2026-09-24. Phases A, C, and D shipped;
Phase B ships the dependency, delivery, runtime-configuration, and
security/test families; the independent-evidence part of Phase E moves to 0.24.
The only remaining item, RP23-001, closes with the tag's public-channel
verification. See the [Release Closure Plan](#release-closure-plan).
