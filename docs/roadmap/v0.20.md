# RepoPilot 0.20.0 — Release Contract
...
| #285 | In progress | Version manifests, curated release notes, changelog, scorecard, and release verification are being finalized for v0.20.0. | Complete all release gates and publish artifacts. |
